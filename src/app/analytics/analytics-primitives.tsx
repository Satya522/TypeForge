...
export function ToneBadge({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-full border px-3 py-1.5 text-[0.68rem] font-semibold uppercase tracking-[0.28em]',
        toneClasses[tone]
      )}
    >
      {label}
...
export function TrendPill({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-full border px-3 py-1.5 text-xs font-semibold tracking-[0.22em]',
        tone
      )}
    >
      {label}
